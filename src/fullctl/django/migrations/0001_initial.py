    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(default=0)),
                ('status', models.CharField(choices=[('ok', 'Ok'), ('pending', 'Pending'), ('deactivated', 'Deactivated'), ('failed', 'Failed'), ('expired', 'Expired')], default='ok', max_length=12)),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_set', to='django_fullctl.Organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(default=0)),
                ('status', models.CharField(choices=[('ok', 'Ok'), ('pending', 'Pending'), ('deactivated', 'Deactivated'), ('failed', 'Failed'), ('expired', 'Expired')], default='ok', max_length=12)),
                ('secret', models.CharField(default=fullctl.django.models.concrete.account.generate_secret, max_length=255)),
                ('org', models.ForeignKey(help_text='owned by org', on_delete=django.db.models.deletion.CASCADE, to='django_fullctl.Organization')),
            ],
            options={
