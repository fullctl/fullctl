...
from fullctl.django.management.commands.fullctl_poll_tasks import Worker, Command
from fullctl.django.management.commands.fullctl_work_task import Command as WorkTaskCommand
...
class TestWorkTaskCommand:
    ...
    def test_work_task_command_max_tasks(self):
        ...
        tasks = [
            models.TestTask.create_task(i, i+1) 
        ...
        assert completed == 2, f"Expected 2 tasks to be completed, but {completed} were completed" 